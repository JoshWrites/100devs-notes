...
function inferTags(body) {
  ...
  const TAG_RULES = [
    { tag: 'networking', keywords: ['networking', 'network', 'coffee chat', 'cold outreach', 'linkedin profile', 'connect with', 'reach out', 'informational interview', 'meetup', 'tech event', 'connection request', 'referral', 'referred', 'introduce yourself', 'make connections'], weight: 2 },
    { tag: 'interview', keywords: ['interview', 'behavioral question', 'star method', 'technical interview', 'whiteboard', 'coding challenge', 'take-home', 'take home', 'mock interview', 'phone screen', 'hiring manager', 'interview prep', 'tell me about yourself', 'leetcode', 'hackerrank', 'algo ', 'algorithm', 'system design', 'pair programming'], weight: 2 },
    { tag: 'resume', keywords: ['resume', 'cv ', 'cover letter', 'application', 'job board', 'apply', 'applying', 'ats ', 'applicant tracking', 'job posting', 'tailor your resume', 'work experience', 'job description', 'wellfound', 'indeed', 'hired', 'hiring'], weight: 2 },
    { tag: 'freelance', keywords: ['freelance', 'freelancing', 'client', 'evergreen client', 'agency', 'contract work', 'invoice', 'upwork', 'fiverr', 'retainer', 'proposal', 'scope of work', 'pricing', 'side hustle', 'gig ', 'subcontract'], weight: 2 },
    { tag: 'portfolio', keywords: ['portfolio', '100 hours', '100hours', 'hundred hours', 'project showcase', 'personal site', 'personal website', 'github profile', 'deploy', 'case study', 'open source', 'open-source', 'contributing', 'contribution', 'maintainer', 'side project', 'proof of work'], weight: 2 },
    { tag: 'branding', keywords: ['social media', 'personal brand', 'content creat', 'blog post', 'blogging', 'twitter', 'x.com', 'bluesky', 'post about', 'posting on', 'online presence', 'thought leader', 'visibility', 'share your', 'write about', 'dev.to', 'hashnode', 'medium', 'youtube', 'tiktok'], weight: 2 },
    { tag: 'mindset', keywords: ['mindset', 'imposter syndrome', 'motivation', 'burnout', 'mental health', 'self care', 'self-care', 'growth mindset', 'embrace the struggle', 'keep going', 'believe in yourself', 'accountability', 'discipline', 'overwhelm', 'patience', 'upward mobility', 'fight for yourself', 'consistency', 'trust the process', 'celebrate'], weight: 2 },
    { tag: 'salary', keywords: ['salary', 'negotiat', 'compensation', 'offer letter', 'equity', 'stock option', 'benefits', 'base pay', 'total comp', 'counter offer', 'pay range', 'market rate', 'raise', 'promotion', 'signing bonus', 'bonus', 'underpaid'], weight: 2 },
    { tag: 'technical', keywords: ['javascript', 'react', 'node.js', 'nodejs', 'express', 'css', 'html', 'typescript', 'python', 'api ', 'database', 'sql', 'mongodb', 'git ', 'github', 'deployment', 'aws', 'docker', 'algorithm', 'data structure', 'leetcode', 'full stack', 'frontend', 'backend', 'next.js', 'vue', 'angular', 'tailwind', 'rest api', 'graphql'], weight: 1 },
  ];
